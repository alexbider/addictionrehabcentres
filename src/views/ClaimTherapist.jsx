'use client';
// Generated from ClaimTherapist.dc.html — layout, styles and copy are a 1:1 port of the design.
...
class Component extends DCLogic {
  ...
  renderVals() {
    ...
    const wide = vw >= 1000,
      mid = vw >= 700;
    // Sample profiles for the prototype — replaced by the real directory search.
    const listings = [
      ['Dr. Maya Chen', 'C.Psych · Toronto, ON', false],
      ['Daniel Okafor', 'RP · Registered Psychotherapist · Toronto, ON', false],
      ['Sophie Tremblay', 'MSW, RSW · Ottawa, ON', true],
      ['Arjun Mehta', 'RCC · Vancouver, BC', false],
      ['Hannah Lefebvre', 'OPQ Psychologist · Montreal, QC', false],
      ['Marcus Bell', 'CCAC · Addiction Counsellor · Winnipeg, MB', false],
      ['Priya Nair', 'R.Psych · Calgary, AB', true],
    ...
    const row = (l) => {
      ...
      return {
        ...
        btnColor: '#fff',
        btnLabel: on ? 'Selected' : 'Claim this profile',
      };
    };
    ...
    const errs = {
      ...
      role: form.role.trim().length < 3 ? 'Enter your college registration number.' : '',
      email: !emailOk ? 'Enter a valid email.' : '',
      phone: '',
    };
    const fields = [
      ['name', 'Full name', 'text', 'Jane Doe'],
      ['role', 'College registration #', 'text', 'e.g. CRPO 012345'],
      ['email', 'Email', 'email', 'you@yourpractice.ca'],
    ...
    const methods = [
      ['phone', 'Registry check', "We match your number with your regulator's public register.", ic.badge],
      ['email', 'Email code', 'We send a code to the email on your practice website.', ic.mail],
      ['doc', 'Document', 'Upload your current registration certificate.', ic.doc],
    ...
    const methodLabel = { email: 'Email code', phone: 'College registry check', doc: 'Registration certificate' }[
      method
    ];
    ...
    const done = step === 5;
    const stepNames = ['Find profile', 'Your details', 'Plan', 'Pay'];
    ...
    const review = [
      ['Profile', s ? s.name + ' · ' + s.address : '', 1],
      ['Name', form.name, 2],
      ['Registration', form.role, 2],
      ['Email', form.email, 2],
    ...
    const unlockDefs = [
      ...
      ['Edit your profile', ic.edit],
      ['Video intro', ic.camera],
      ['Profile stats', ic.chart],
    ];
    ...
    return {
      ...
      resultsLabel: match.length + (match.length === 1 ? ' profile' : ' profiles') + ' found',
      perks: ['Get the Verified badge', 'Set your fees & specialties', 'Full refund if not verified'],
      pvName: s ? s.name : 'Your name',
      pvAddress: s ? s.address : 'Designation · City, Province',
      ...
      form,
      nextSteps: [
        { n: '1', t: 'We verify your registration', b: 'Our team checks your credentials using the method you chose.' },
        {
          n: '2',
        ...
        {
          n: '3',
          t: 'Your profile goes Verified',
          b: 'Set your fees, specialties and availability, and start receiving enquiries.',
        },
      ],
      ...
      asName: s ? s.name : 'No profile selected',
  ...
  return (
    <>
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
        ...
        <section
          data-screen-label="Therapist claim hero"
          style={{
            position: 'relative',
            background:
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', gap: '22px', minWidth: '0' }}>
              ...
              <h1 style={$css(`font:600 ${h1Size ?? ''}/1.04 Jost,sans-serif;color:#10233a`)}>
                Claim your therapist <span style={{ color: '#0890E8' }}>profile</span>
              </h1>
              <p style={{ fontSize: '19px', lineHeight: '1.6', color: '#516378', maxWidth: '540px' }}>
                Find your profile, confirm your registration, and choose a subscription to manage how clients see you on
              ...
              <div style={{ position: 'relative', maxWidth: '600px' }}>
                ...
                >
                  ...
                  <input
                    ...
                    onBlur={onSearchBlur}
                    placeholder="Search by name, city or designation"
                    aria-label="Search for your profile"
                    style={{
                      flex: '1',
                      minWidth: '0',
                      height: '100%',
                        ...
                        <>
                          ...
                          >
                            <span style={{ font: '600 15px Jost,sans-serif', color: '#10233a' }}>
                              No profile matches “{$i(query)}”
                            </span>
                            <span style={{ fontSize: '14px', color: '#516378' }}>
                              Try your city or designation, or{' '}
                              <$A href={'/auth?mode=signup&type=therapist'} style={{ fontWeight: '600' }}>
            ...
            >
                ...
                <>
                  ...
                  >
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                      <h2 style={{ fontSize: '28px' }}>Find your profile</h2>
                      <p style={{ fontSize: '15.5px', color: '#516378' }}>
                        Select your profile from the directory. Profiles marked Claimed are already managed by the
                        therapist.
                      </p>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <input
                        value={$val(query)}
                        onChange={onQuery}
                        placeholder="Filter by name, city or designation"
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                      ...
                      {noAll ? (
                        <>
                          ...
                          >
                            <span style={{ font: '600 16px Jost,sans-serif' }}>We couldn't find that profile</span>
                            <span style={{ fontSize: '14.5px', color: '#516378' }}>
                              You may not be listed yet.{' '}
                              <$A href={'/auth?mode=signup&type=therapist'} style={{ fontWeight: '600' }}>
                                Create a new therapist profile
                              </$A>
                              .
              ...
              {isStep2 ? (
                <>
                  ...
                  >
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                      <h2 style={{ fontSize: '28px' }}>Confirm this is you</h2>
                      <p style={{ fontSize: '15.5px', color: '#516378' }}>
                        We use these details to confirm you are{' '}
                        <strong style={{ color: '#10233a' }}>{$i(selName)}</strong> and that your registration is
                        current.
                      </p>
                    </div>
                    ...
                    >
                      ...
                      <span style={{ fontSize: '14.5px', lineHeight: '1.5', color: '#3b4d63' }}>
                        I confirm I am {$i(selName)} and the credentials on this profile are my own.
                      </span>
                    </button>
                    <span
                      style={$css(
                    ...
                    >
                      Please confirm this profile is yours to continue.
                    </span>
                    <div
                      style={{
                        display: 'flex',
                ...
                <>
                  ...
                  >
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                      ...
                      <p style={{ fontSize: '15.5px', color: '#516378' }}>
                        A subscription is required to claim and manage a profile. Pick the plan that fits your practice.
                      </p>
                    </div>
                    ...
                    >
                      <span style={{ fontSize: '14.5px', color: '#3b4d63', flex: '1', minWidth: '220px' }}>
                        Group practice with several therapists? We can set up every profile together.
                      </span>
                      <$A
                        href="/contact"
                        style={{
                ...
                <>
                  ...
                  >
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                      ...
                      <p style={{ fontSize: '15.5px', color: '#516378' }}>
                        Your subscription starts today. Our team then checks your registration — if we can't approve the
                ...
                <>
                  ...
                  >
                    ...
                    <p style={{ fontSize: '16px', lineHeight: '1.6', color: '#516378', maxWidth: '520px' }}>
                      ...
                      sent to {$i(form?.email)}. If we can't verify your registration, we'll refund you in full.
                    </p>
                    <ol
                      style={$css(
...
const View = createDC('ClaimTherapist', Component, template);
export default View;
