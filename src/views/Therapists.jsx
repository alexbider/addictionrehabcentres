'use client';
// Generated from Therapists.dc.html — layout, styles and copy are a 1:1 port of the design.
  ...
  return (
    <>
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
        ...
        >
          <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '28px 32px 72px' }} data-rc-wrap="1">
            <nav
            ...
            >
              ...
              <span style={{ color: '#10233a', fontWeight: '500' }}>Find a Therapist</span>
            </nav>
            <div
            ...
            >
              <div style={{ display: 'flex', flexDirection: 'column', gap: '22px' }}>
                ...
                >
                  {$list(dirTabs).map((dt, $index) => (
                    <Fragment key={$index}>
                      <$A
                        className="scp0"
                        href={dt?.href}
                        style={$css(
                          `font:600 13.5px Jost,sans-serif;padding:8px 16px;border-radius:999px;background:${dt?.bg ?? ''};color:${dt?.color ?? ''}`,
                        )}
                      >
                        {$i(dt?.label)}
                      </$A>
                ...
                <h1 style={{ fontSize: '56px', lineHeight: '1.04', color: '#10233a' }} data-rc-lg="1">
                  Find an Addiction Counsellor or Therapist <span style={{ color: '#0890E8' }}>Near You</span>
                </h1>
                <p style={{ fontSize: '18px', lineHeight: '1.55', color: '#516378', maxWidth: '560px' }}>
                  Browse registered psychotherapists, psychologists and addiction counsellors across Canada. Filter by
                  concern, location and session type — in person or online.
                </p>
                <form
                  action="#"
                  style={{
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: '13px', color: '#6b7f95', marginTop: '4px' }}>Registered professionals</div>
                  </div>
                  <div>
                    <div style={{ font: '600 24px Jost,sans-serif', lineHeight: '1' }}>{$i(thCities)}</div>
                    <div style={{ fontSize: '13px', color: '#6b7f95', marginTop: '4px' }}>Cities across Canada</div>
                  </div>
                  <div>
                    <div style={{ font: '600 24px Jost,sans-serif', lineHeight: '1' }}>100%</div>
                    <div style={{ fontSize: '13px', color: '#6b7f95', marginTop: '4px' }}>
                      Credentials checked against provincial colleges
                    </div>
                  </div>
                </div>
              </div>
              <div style={{ position: 'relative' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }} data-cols="1fr 1fr">
                  {$list(heroTherapists).map((ht, $index) => (
                    <Fragment key={$index}>
                      <div
                        style={{
                          background: '#fff',
                          ...
                          flexDirection: 'column',
                          gap: '10px',
                          boxShadow: '0 20px 40px -30px rgba(16,35,58,.35)',
                        }}
                      >
                        <div
                          style={{
                        ...
                        <div>
                          <div style={{ font: '600 14px Jost,sans-serif' }}>{$i(ht?.name)}</div>
                          <div style={{ fontSize: '12px', color: '#6b7f95' }}>{$i(ht?.cred)}</div>
                        </div>
                        <span
                          style={{
                            alignSelf: 'flex-start',
                            font: '500 11px Figtree,sans-serif',
                            color: '#2fb46b',
                            background: '#e9f8ef',
                            padding: '3px 8px',
                            borderRadius: '999px',
        ...
        <section data-screen-label="By location" style={{ background: '#fff', borderTop: '1px solid #e9eff5' }}>
          <div
            style={{
              maxWidth: '1280px',
              margin: '0 auto',
          ...
          >
            <div>
              <div>
                ...
                <h2 style={{ fontSize: '30px', marginTop: '8px', marginBottom: '20px' }}>Therapists across Canada</h2>
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }} data-cols="1fr 1fr">
                {$list(thProvinces).map((pv, $index) => (
                  <Fragment key={$index}>
                    <$A
                      className="scph"
                      href={pv?.href}
                    ...
                    >
                      ...
                      <span style={{ font: '500 14px Figtree,sans-serif' }}>{$i(pv?.label)}</span>
                    </$A>
                  </Fragment>
                ))}
              </div>
            ...
            <div>
              ...
              <div
                ...
                data-cols="repeat(auto-fill,minmax(150px,1fr))"
              >
                {$list(thCityList).map((ct, $index) => (
                  <Fragment key={$index}>
                    <$A
                      className="scp2"
                      href="#"
                    ...
                    >
                      <span>{$i(ct?.name)}</span>
                      <span style={{ color: '#6b7f95', fontSize: '12px' }}>{$i(ct?.prov)}</span>
                    </$A>
                  </Fragment>
                ))}
              </div>
...
export const defaults = { thCount: 320 };
const View = createDC('Therapists', Component, template);
export default View;
