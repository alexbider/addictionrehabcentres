'use client';
// Generated from TherapistsCity.dc.html — layout, styles and copy are a 1:1 port of the design.
...
class Component extends DCLogic {
  ...
  renderVals() {
    ...
    // ---- Location page data ----
    const locName = this.props.locName ?? 'Toronto';
    const locProvince = 'Ontario';
    const locCollege = 'CRPO, CPO & OCSWSSW';
    const locIntro =
      'Browse registered psychotherapists, psychologists, social workers and addiction counsellors in Toronto — downtown, midtown, Scarborough, Etobicoke and North York — offering in-person and online sessions.';
    const locSub = [
      'Downtown|64',
      'Midtown|38',
      'Scarborough|22',
            ...
            >
              ...
              <div style={{ position: 'relative' }}>
                ...
                >
                  ...
                  >
                    map · {$i(locName)} therapist locations
                  </span>
                </div>
                <div
                  style={{
...
export const defaults = { locName: 'Toronto', thCount: 210 };
const View = createDC('TherapistsCity', Component, template);
export default View;
